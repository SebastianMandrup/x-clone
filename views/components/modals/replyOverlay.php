<div id='divReplyOverlay' class='hidden'>
	<section id='sectionReply'>
		<button id='btnCloseReplyOverlay' type='button' aria-label='Close Reply Overlay'>
			&times;
		</button>

		<section id='sectionReplyToInfo'>
			<img id="imgReplyToAvatar" src="" alt="">
			<section id='sectionReplyToHeader'>
				<p id='pReplyToUsername'>
					Username
				</p>
		...
		<section id='sectionReplyingTo'>
			<p id='pReplyToContent'>
				content
			</p>
		...
		<form action="/api/add-comment-reply" method="post" id='formReplyToPost'>
			...
			<div id='divReplyFormBottom'>
				...
				<button type="submit" id='btnSubmitReply'>Reply</button>
			</div>
		</form>
